...
export default function WhatsAppFloatButton({
    ...
    return (
        <a
            ...
            className={`fixed bottom-6 right-6 z-[60] inline-flex items-center gap-2 rounded-full bg-whatsapp px-5 py-3 text-[0.95rem] font-semibold text-forest-deep no-underline shadow-lg transition-all duration-300 hover:bg-forest-deep hover:text-whatsapp hover:shadow-xl hover:no-underline md:bottom-8 md:right-8 ${
                isVisible
