    ...
    return (
        <footer className="bg-forest-deep text-paper mt-6">
            <div className="mx-auto max-w-content px-7 pt-12 pb-8">
                    ...
                    <div className="space-y-4">
                        ...
                        <p className="text-sm text-paper/70 max-w-[38ch]">
                            ...
                            <a
                                ...
                                className="text-paper hover:text-white underline underline-offset-2"
                            >
                        ...
                        <div className="flex items-center gap-1">
                            <FacebookIcon
                                href={FACEBOOK_URL}
                                className="p-2 rounded-lg text-paper/70 transition-colors hover:bg-white/10 hover:text-white"
                            />
                            <YouTubeIcon
                                href={YOUTUBE_URL}
                                className="p-2 rounded-lg text-paper/70 transition-colors hover:bg-white/10 hover:text-white"
                    ...
                    >
                        {policyLinks.map((l) => (
                            <Link
                                key={l.href}
                                href={l.href}
                                className="text-[0.88rem] text-paper/70 no-underline hover:text-white transition-colors"
                            >
                                {l.label}
                            </Link>
                        ))}
                ...
                <p className="mt-7 border-t border-paper/20 pt-4 text-[0.78rem] text-paper/60">
